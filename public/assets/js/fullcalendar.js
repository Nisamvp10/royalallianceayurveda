...
var FullCalendar = (function (e) {
    ...
    (jo.prototype.classes = { root: "fc-theme-standard", tableCellShaded: "fc-cell-shaded", buttonGroup: "fc-button-group flex items-center border border-gray-300 rounded-lg overflow-hidden", button: "px-3 py-2 bg-blue-600 text-white btn-primary capitalize", buttonActive: "fc-button-active" }),
    ...
    function kl(e) {
        let t = ["fc-timegrid-slot ", " fc-timegrid-slot-label px-2 py-4 whitespace-nowrap text-sm text-gray-900 border-r", e.isLabeled ? "fc-scrollgrid-shrink" : "fc-timegrid-slot-minor"];
        return p(qr.Consumer, null, (n) => {
