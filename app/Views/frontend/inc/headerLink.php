...
<meta property="og:image" content="<?=base_url('public/assets/template/');?>assets/img/og-cheeta.jpg">
<meta property="og:site_name" content="Royal Alliance Ayurveda">

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:url" content="https://royalallianceayurveda.com">
...
<meta name="twitter:image" content="<?=base_url('public/assets/template/');?>assets/img/og-cheeta.jpg">
    ...
    <link rel="stylesheet" href="<?=base_url('public/assets/template/');?>assets/css/slick.css">
    <link rel="stylesheet" href="<?=base_url('public/assets/template/');?>assets/css/default-icons.css">
    <link rel="stylesheet" href="<?=base_url('public/assets/template/');?>assets/css/default.css">
    <link rel="stylesheet" href="<?=base_url('public/assets/template/');?>assets/css/sal.css">
    <link rel="stylesheet" href="<?=base_url('public/assets/template/');?>assets/css/tg-cursor.css">
...
})(window,document,'script','dataLayer','GTM-TKJ4LSM7');</script>
