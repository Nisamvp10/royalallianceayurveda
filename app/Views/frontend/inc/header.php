...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TKJ4LSM7"
 ...
 <!--Preloader-->
    <div id="preloader">
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class="loader-icon"><img src="<?=base_url('public/assets/template/');?>assets/img/fav.png" alt="Preloader"></div>
            </div>
        </div>
    </div>
    <!--Preloader-end -->
    ...
    <header class="transparent-header">
                    ...
                    <div class="col-12">
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                <div class="logo">
                                    <a href="<?=base_url();?>"><img src="<?=base_url('public/assets/template/');?>assets/img/logo.png" alt="Logo"></a>
                                </div>
                                ...
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-xl-flex">
                                    <ul class="navigation">
                                        <li class="<?=($page == 'Home')?'active':'';?>"><a href="<?=base_url();?>">Home</a></li>
                                          <li class="menu-item-has-children <?=($page == 'Products')?'active':'';?>"><a href="<?=base_url('products');?>" class="section-link">Products</a>
                                        <ul class="sub-menu">
                                                <li><a href="<?=base_url('products');?>">Cheetah</a></li>
                                ...
                                <div class="tgmenu__action">
                                    <ul class="list-wrap">
                                        <li class="header-cart">
                                            <a href="#l" class="cart-count headerCart__button">
                                                ...
                                                <span id="cartCount" class="mini-cart-count">0</span>
                                            </a>
                                        </li>
        ...
        <div class="offCanvas-wrap">
            ...
            <div class="offCanvas-body">
                <div class="offCanvas-content">
                     <h3 class="title">Royal Alliance Ayurveda is a trusted name in <span>Ayurvedic wellness</span></h3>
                    <!-- <h3 class="title">Getting all of the <span>Nutrients</span> you need simply cannot be done without supplements.</h3> -->
                    <p>Our product range includes general health supplements, immunity-support products, vitality boosters, and specialized Ayurvedic formulations</p>
                </div>
                <div class="offcanvas-contact">
                    <h4 class="number"><?= getappdata('phone') ?></h4>
                    <h4 class="email"><?= getappdata('email') ?></h4>
                    <p><?= getappdata('address') ?></p>
                    <ul class="offcanvas-social list-wrap">
                        ...
                        <li>
                            <a href="<?=base_url('signup')?>" target="_blank">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M10 17l5-5-5-5v3H3v4h7v3z"/>
                                </svg> Register
                            </a>
        ...
        <div class="mini__cart-wrap">
            <div class="mini__cart-toggle"><img src="<?=base_url('public/assets/template/');?>assets/img/close.png" alt="icon"></div>
            <div class="mini__cart-top">
                <h4 class="mini__cart-title">Shopping cart</h4>
                <!-- <div class="mini__cart-shop">
                    <p>Free Shipping for all orders over <span>Rs 500</span></p>
