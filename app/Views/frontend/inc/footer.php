    ...
    <!-- footer-area -->
    <footer class="footer__area footer__bg" data-background="<?=base_url('public/assets/template/');?>assets/img/footer_bg.jpg">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            <div class="footer__logo">
                                <a href="#"><img src="<?=base_url('public/assets/template/');?>assets/img/logo.png" alt="logo"></a>
                            </div>
                            ...
                            <ul class="list-wrap footer__social">
                                ...
                                <li>
                                    <a href="https://www.instagram.com/cheetah.ayurvedic?igsh=ZDFtdnA5NWRsMXo=" target="_blank">
                                    ...
                                    <path d="M14.8852 4.19411C14.8852 4.79176 14.4 5.2734 13.8059 5.2734C13.2082 5.2734 12.7266 4.78825 12.7266 4.19411C12.7266 3.59645 13.2117 3.11481 13.8059 3.11481C14.4 3.11481 14.8852 3.59996 14.8852 4.19411Z" fill="currentColor"></path>
                                </svg>
                                    </a>
                                </li>
                                <li>
  ...
  <path fill="currentColor" d="M23.498 6.186a2.997 2.997 0 0 0-2.112-2.122C19.545 3.5 12 3.5 12 3.5s-7.545 0-9.386.564A2.997 2.997 0 0 0 .502 6.186 31.72 31.72 0 0 0 0 12a31.72 31.72 0 0 0 .502 5.814 2.997 2.997 0 0 0 2.112 2.122C4.455 20.5 12 20.5 12 20.5s7.545 0 9.386-.564a2.997 2.997 0 0 0 2.112-2.122A31.72 31.72 0 0 0 24 12a31.72 31.72 0 0 0-.502-5.814z"/>
  <path fill="#000" d="M9.75 15.02V8.98L15.5 12l-5.75 3.02z"/>
</svg>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="footer__widget">
                            ...
                            <ul class="list-wrap footer__widget-link">
                                ...
                                <li><a href="<?=base_url('shipping-policy');?>">Shipping  Delivery Policy</a></li>
                                 <li><a href="<?=base_url('refund-and-cancellation');?>">Refund Policy  </a></li>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__payment">
                                <img src="<?=base_url('public/assets/template/');?>assets/img/payment.svg" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row aling-items-center">
                    <div class="col-lg-5 order-0 order-lg-2">
                        <ul class="footer__bottom-right list-wrap">
                            <li>
                                Need support?
                                <a href="#">+91 9656954040</a>
                            </li>
                            <li>
                                Customer care
                                <a href="#">sales@royalallianceayurveda.com</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-7">
                        <div class="copyright__content">
                            <p>Copyright ©2026  Royal Alliance All Rights Reserved </p>
                        </div>
                    </div>
                </div>
            </div>
