        ...
        <div class="col-lg-12">
            <div class="d-flex justify-content-between align-items-center mb-0">
                ...
                <div>
                    ...
                    <a href="javascript:void(0)" onclick="openPanel()" class="btn btn-primary">
                        <i class="bi bi-plus-circle me-1"></i> Create <?= $labels['menu'] ?? '' ?> 
                    </a>
                </div>
                <?php } ?>
            </div>
...
<script src="<?=base_url(relativePath: 'public/assets/js/blog.js')?>" ></script>
