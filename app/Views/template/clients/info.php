    ...
    <div class="flex items-center justify-between">
        <div class="col-lg-12">
            <div class="d-flex justify-content-between align-items-center mb-0">
                ...
                <div>
                    <a href="<?= base_url('service/create/'.$clientId) ?>" class="btn btn-primary">
                        <i class="bi bi-plus-circle me-1"></i>  <?=$labels['products'] ?? '' ;?>
                    </a>
               ...
               <div >
                <label class="block text-sm font-medium text-gray-700 mb-1">Url</label>
                    <div class="relative">
                        ...
                        <input type="text" readonly value="<?= $url ?>"  name="url"  id="url" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Your Position">
                ...
                <div >
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute inset-y-0 left-0 pl-3 mt-2 items-center pointer-events-none"><i class="bi bi-bag-dash text-xl text-gray-400"></i></i></div>
                        <input type="text" name="title" value="<?= $title ?>"  id="title" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Your Name">
...
<?= view('template/panelslider/blogpanel');?>
<?= $this->endSection();?>
