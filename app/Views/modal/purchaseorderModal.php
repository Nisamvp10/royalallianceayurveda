...
<div id="purchaseInfoModal" 
  ...
  <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[100vh] min-h-[80vh] overflow-y-auto">
    ...
    <div class="flex items-center justify-between p-6 border-b border-gray-200">
      ...
      <button id="closeInfoModal" class="p-2 text-gray-400 hover:text-gray-600 !rounded-full hover:bg-gray-100 transition-colors ">
