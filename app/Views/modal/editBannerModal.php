<!-- Banner Modal -->
<div id="editBanner" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 wrapModal">
  <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[100vh] min-h-[80vh] overflow-y-auto">
    <div class="flex items-center justify-between p-6 border-b border-gray-200">
      <h2 class="text-2xl font-bold text-gray-900">Add New Banner</h2>
    ...
    <div class="p-6">
        <form class="p-6 space-y-6" id="bannerForm" enctype="multipart/form-data"> 
                   ...
                   <div class="form-group ">
                    <label class="block text-gray-700 font-semibold mb-2">Upload Banner Image</label>
                      <input type="hidden" name="selected_image" id="selected_image">
                            <button type="button" id="openUploader" class="bg-gray-100 border px-4 py-2 rounded hover:bg-gray-200 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent block w-full text-sm text-gray-700 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none">
                                Choose Banner Image
                            </button>
            ...
            <div class="flex justify-end space-x-4 pt-6 gap-3 border-t border-gray-200">
                ...
                <button type="submit" id="submitBtn" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors !rounded-md">Create Product</button>
            </div>
        </form>
    </div>
  </div>
