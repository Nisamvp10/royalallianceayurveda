    ...
    <div class="flex items-center justify-between">
        <div class="col-lg-12">
            <div class="d-flex justify-content-between align-items-center mb-0">
                ...
                <div>
                    <a onclick="openExpertiseModal()" id="secTitle" data-title="<?=ucwords(getappdata('partnership'))?>"  class="btn btn-primary"> 
                        <!-- onclick="toggleModal('bannerModal', true)"  -->
                        <i class="bi bi-plus-circle me-1"></i> Add <?=ucwords(getappdata('partnership'));?>
                    </a>
                </div>
                <?php } ?>
            </div>
