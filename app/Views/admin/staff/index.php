...
<?= view('modal/staffModal');?>
<!-- view('modal/editBannerModal'); -->
<?= view('modal/uploadGalleryModal');?>
 <!-- Cose Modal -->
<?= $this->endSection(); ?>
<?= $this->section('scripts') ?>
<script src="<?=base_url('public/assets/js/staff.js');?>" ></script>
                                ...
                                <div class="px-3 py-3 whitespace-nowrap_">
                                    ...
                                    <div class="flex items-start">
                                        <div class="mt-2 space-y-2">
                                            ...
                                            <div class="flex items-center flex text-sm text-gray-600">
                                              <a target="_balank" href="${user.facebook ? user.facebook :'' }"><i class="bi bi-facebook mr-2"></i></a>
                                              <a target="_balank" href="${user.instagram ? user.instagram :'' }" ><i class="bi bi-instagram mr-2"></i></a>
                                              <a target="_balank" href="${user.twitter ? user.twitter :'' }" ><i class="bi bi-twitter mr-2"></i></a>
                                              <a target="_balank" href="${user.linkedin ? user.linkedin :'' }" ><i class="bi bi-linkedin mr-2"></i></a>
                                            </div>
                                        </div>
                                    </div>
