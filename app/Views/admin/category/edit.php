...
?>
 ...
 <div class="flex items-center justify-between">
    <div class="flex items-center gap-4">
        <a href="<?=base_url('admin/categories');?>" class="p-2 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <div class="space-y-4">
                <div >
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="category" value="<?=$category;?>"  id="branch" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Your Name">
