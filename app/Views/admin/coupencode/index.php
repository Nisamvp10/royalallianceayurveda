    ...
    <div class="flex items-center justify-between">
        <div class="col-lg-12">
            <div class="d-flex justify-content-between align-items-center mb-0">
                ...
                <div>
                    <a onclick="openModal()" id="openModal" data-title="Coupen code"  class="btn btn-primary"> 
...
<script>
    App.init({
        siteUrl: '<?=base_url();?>',
        cust: '<?=base_url('admin/'.slugify(getappdata('coupencode')));?>',
    });
</script>
...
<script src="<?=base_url('public/assets/js/coupencode.js');?>"></script>
